...
:white_large_square: Estadísticas básicas - cuales? Markdown "Basic Statistics" en la carpeta "Analysis"
...
:wavy_dash: Anotar referencias en artículos descargados

:red_circle: Definir criterios de referenciación
...
:white_large_square: Sistematizar anotaciones sobre referencia espacial en una tabla/BD con: id (key?), coordenadas y tipo de vector (punto, línea, polígono) - Base de datos PostgreSQL-PostGIS

:wavy_dash: Aprender a manejar información espacial QGIS http://www.qgis.org/es/site/ IN PROCESS
