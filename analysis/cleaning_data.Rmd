...
# Export auxiliar data with desired fields 
...
```{r}
# Create key 
# Sort by year (ascending) and by Authors..Primary (alphabetically)
rawdf <- rawdf %>% 
...
aux <- rawdf %>% 
  select(key, Authors..Primary, Title.Primary, Pub.Year, Periodical.Full, Periodical.Abbrev, Keywords)
