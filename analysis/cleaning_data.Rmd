...
all_authors_clean <- as.data.frame(stringr::str_replace_all(all_authors$author, pattern = ",", replacement = " "))
all_authors_clean <- unique(all_authors_clean)
names(all_authors_clean)[1] <- 'author'
