...
- An identification key was assigned to each reference. The criteria used for this classification was based on chronological ascending order and alphabetical order of the authors within publication year. # Note: this step is not really necesary and actually it may should be excluded, since from the whole list some papers will be excluded (and therefore the key won't be continuous) and doesn't need to be shown. 
